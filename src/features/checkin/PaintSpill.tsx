...
import { RAISED_OVERLAP, RAISED_SIZE, TAB_BAR_HEIGHT } from '@/components/GlassTabBar';
...
export function PaintSpillOverlay() {
  ...
  const targetY =
    height - insets.bottom - Spacing.sm - TAB_BAR_HEIGHT + RAISED_OVERLAP - RAISED_SIZE / 2;
